...
const gifts: Gift[] = [
  ...
  gift("regalo-021", "Picnic en la plaza", 25000, "Experiencias", "/gifts/Picnic_v02.png", "Manta, sol y algo rico: el plan perfecto. ¡Gracias!"),
  ...
  gift("regalo-025", "Visitar el Titanic", 250000, "Experiencias", "/gifts/titanic_v02.png", "Si encontramos el collar hacemos mitad y mitad. ¡Gracias!"),
  ...
  gift("regalo-027", "TourVinos Mendoza", 550000, "Luna de miel", "/gifts/Mendoza_v02.png", "No nos gusta el vino, pero vamos a hacer el esfuerzo igual. ¡Gracias!"),
