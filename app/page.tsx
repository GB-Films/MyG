...
const gifts: Gift[] = [
  gift("regalo-028", "Asado para toda la Flia", 150000, "Nuestro hogar", "/gifts/asado_v01.jpg", "Están invitados a ese asado, obviamente. ¡Gracias!"),
  gift("regalo-001", "Buceo en Tailandia", 130000, "Luna de miel", "/gifts/buceo_v02.png", "¡Al fin vamos a poder conocer a Nemo! ¡Gracias!"),
  gift("regalo-012", "Excursion con Gorilas", 1200000, "Experiencias", "/gifts/gorilas_v02.png", "Bueno, esperemos no morir. ¡Gracias por impulsarnos a esta aventura!"),
  gift("regalo-023", "Globo Aerostático por Turquía", 600000, "Experiencias", "/gifts/globo_v02.png", "Nos regalaron una vista que no vamos a olvidar nunca. ¡Mil gracias!"),
  gift("regalo-024", "Noche de Truco con Paredes y De Paul", 300000, "Nuestro hogar", "/gifts/truco_v01.png", "La camiseta firmada es para vos, mil gracias!!!"),
  gift("regalo-020", "Paseo en barco por Capri", 275000, "Luna de miel", "/gifts/barcoCapri_v02.png", "Capri desde el mar va a ser inolvidable. ¡Gracias por llevarnos!"),
  gift("regalo-026", "Pisar la Luna", 93000, "Luna de miel", "/gifts/luna_v02.png", "Nos acaba de llegar un mensaje de la NASA avisándonos de la misión. ¡Gracias por hacer esto posible! Después les mandamos video."),
  gift("regalo-008", "Entradas para la F1", 450000, "Experiencias", "/gifts/F1_v02.png", "Cuando tengamos la foto con Franco se las pasamos. ¡Gracias!"),
  ...
  gift("regalo-004", "Camión de Coca-Cola", 350000, "Nuestro hogar", "/gifts/CamionCoca_v02.png", "¡Coca de por vida, seeeee! ¡Gracias!"),
  ...
  gift("regalo-030", "Viaje en Primera Clase", 1800000, "Luna de miel", "/gifts/avion_v02.png", "Lo bueno es que si el avión se cae vamos a estar durmiendo muy cómodos. ¡Gracias!"),
  gift("regalo-013", "Latas de Atún La Campagnola x3", 30000, "Nuestro hogar", "/gifts/latasAtun_v01.png", "Van directo a la caja fuerte, gracias!"),
  gift("regalo-014", "Llenar el tanque", 100000, "Nuestro hogar", "/gifts/Tanque_v01.png", "Muchas gracias, después te pasamos la cuenta de serviclub asi nos cargas los puntos para la pelota del verano."),
  gift("regalo-006", "2 Combos Doble Cuarto de Libra", 46000, "Nuestro hogar", "/gifts/dobleCuarto.png", "Nos viene de 10 para el bajón post casorio. Gracias!"),
  gift("regalo-016", "Masajes de 60 minutos", 140000, "Experiencias", "/gifts/masajes_v02.png", "Este descanso nos va a venir increíble después del casamiento. ¡Gracias!"),
  ...
  gift("regalo-018", "Noche de Cine Premium", 80000, "Experiencias", "/gifts/cinePremium.png", "Titanic y pochoclos dulces. Planazo, gracias!"),
  gift("regalo-019", "Paquete de Lays", 4000, "Nuestro hogar", "/gifts/lays_v01.png", "Que nunca falten las papitas, gracias!"),
  gift("regalo-015", "Llenar la heladera", 250000, "Nuestro hogar", "/gifts/Heladera_v01.png", "Uhh nos viene re bien después de todo lo que gastamos en el casorio, gracias!!!"),
  gift("regalo-021", "Picnic en la plaza", 25000, "Experiencias", "/gifts/Picnic_v02.png", "Aguante los sanguchitos de miga, la rompiste!"),
  gift("regalo-022", "Safari por Africa", 750000, "Experiencias", "/gifts/safari_v01.png", "Siii, al fin vamos a poder cazar un elefante… jajja joda. Mil gracias por este regalo increíble!"),
  gift("regalo-005", "Cena en la Torre Eiffel", 400000, "Luna de miel", "/gifts/TorreEiffel_v01.png", "Lo bien que vamos a comer. ¡Mil gracias, en serio! Después les mandamos foto."),
  gift("regalo-007", "Clase de Doble de Riesgo", 180000, "Experiencias", "/gifts/ClaseDoble_v01.png", "Esperemos no morir en el intento. Mil gracias!"),
  gift("regalo-025", "Visitar el Titanic", 250000, "Experiencias", "/gifts/titanic_v02.png", "Si encontramos el collar de Rose hacemos mitad y mitad. ¡Mil gracias!"),
  ...
  gift("regalo-027", "Tour de Vinos en Mendoza", 550000, "Luna de miel", "/gifts/Mendoza_v02.png", "No nos gusta el vino, pero vamos a hacer el esfuerzo igual, jodaaa. ¡Mil gracias!"),
...
const customGiftDeliveryCopy: Partial<Record<string, string>> = {
  ...
  "regalo-013": "vamos a recibir las “Latas de Atún La Campagnola x3” en nuestra casa.",
  ...
  "regalo-004": "vamos a recibir un “Camión de Coca-Cola” en nuestra casa.",
  ...
  "regalo-009": "vamos a recibir una “Máquina de Arcade” por Mercado Libre en nuestra casa.",
