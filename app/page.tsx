...
const gifts: Gift[] = [
  ...
  gift("regalo-002", "Cargar la SUBE", 100000, "Experiencias", "/gifts/100k para la sube.jpg", "Listo, ya sabemos que por un año entero no tenemos que cargar la SUBE. ¡Gracias!"),
  ...
  gift("regalo-008", "Entradas para la F1", 450000, "Experiencias", "/gifts/Entradas F1.jpg", "Cuando tengamos la foto con Franco se las pasamos. ¡Gracias!"),
  gift("regalo-009", "Máquina de arcade", 3000000, "Nuestro hogar", "/gifts/Flipper.jpg", "¡Nos llegó el mensaje de Mercado Libre: ya está en camino! Mil gracias de verdad; están invitados a jugar cuando quieran."),
  gift("regalo-010", "Fotolibro de la luna de miel", 120000, "Nuestro hogar", "/gifts/FotoLibro.webp", "Que nunca falten las fotos impresas. ¡Gracias!"),
  gift("regalo-011", "Noche de glamping en Bali", 275000, "Luna de miel", "/gifts/glamping.jpg", "Qué bueno va a ser tomar unos mates ahí. ¡Mil gracias!"),
  ...
  gift("regalo-013", "Latas de atún La Campagnola x3", 30000, "Nuestro hogar", "/gifts/latas de atun.webp", "La alacena ya está oficialmente salvada. ¡Gracias por este regalo de emergencia!"),
  gift("regalo-014", "Llenar el tanque", 100000, "Nuestro hogar", "/gifts/Llenar el tanqu.jpg", "Tanque lleno y ruta libre. ¡Gracias por ayudarnos a seguir viaje!"),
  gift("regalo-015", "Llenar la heladera", 250000, "Nuestro hogar", "/gifts/Llenar la heladera.webp", "La heladera llena y nosotros felices. ¡Mil gracias!"),
  ...
  gift("regalo-017", "Dos noches all inclusive", 850000, "Luna de miel", "/gifts/Noche All inclusive.jpg", "Dos noches para no pensar en nada más que disfrutar. ¡Mil gracias!"),
  ...
  gift("regalo-019", "Paquete de Lays", 4000, "Nuestro hogar", "/gifts/Paquete de lays.webp", "El snack más importante de nuestra historia ya está asegurado. ¡Gracias!"),
  ...
  gift("regalo-027", "Tour de vinos en Mendoza", 550000, "Luna de miel", "/gifts/TourVinos Mendoza.jpg", "No nos gusta el vino, pero vamos a hacer el esfuerzo igual. ¡Gracias!"),
  gift("regalo-028", "Un asado de domingo", 150000, "Nuestro hogar", "/gifts/asado_v01.jpg", "Están invitados a ese asado, obviamente. ¡Gracias!"),
  gift("regalo-029", "Van para recorrer el país", 3500000, "Luna de miel", "/gifts/Van para recorrer el mundo.jpg", "¡No lo podemos creer! Mil gracias de verdad; ahora, a viajar por todo el país."),
  gift("regalo-030", "Viaje en primera clase", 1800000, "Luna de miel", "/gifts/primeraClase.webp", "Lo bueno es que, si el avión se cae, vamos a estar durmiendo muy cómodos. ¡Gracias!"),
];
