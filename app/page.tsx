...
const gifts: Gift[] = [
  ...
  gift("regalo-004", "Camion de Coca Cola", 350000, "Nuestro hogar", "/gifts/CamionCoca_v02.png", "¡Coca de por vida, seeeee! ¡Gracias!"),
  ...
  gift("regalo-013", "Latas de Atun La Campagnola x3", 30000, "Nuestro hogar", "/gifts/latasAtun_v01.png", "Van directo a la caja fuerte, gracias!"),
